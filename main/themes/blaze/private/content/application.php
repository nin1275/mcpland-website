          ...
          <?php if ($application->rowCount() > 0): ?>
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col">
                    <h5 class="mb-0"><?php echo substr($readApplication["title"], 0, 50); ?></h5>
                  </div>
                  <div class="col-auto">
                    <?php if ($readApplication["status"] == 0): ?>
                      <span class="badge badge-pill bg-danger" data-bs-toggle="tooltip" data-placement="top" data-original-title="<?php e__('Status') ?>"><?php e__('Rejected') ?></span>
                    <?php elseif ($readApplication["status"] == 1): ?>
                      <span class="badge badge-pill bg-success" data-bs-toggle="tooltip" data-placement="top" data-original-title="<?php e__('Status') ?>""><?php e__('Approved') ?></span>
                    <?php elseif ($readApplication["status"] == 2): ?>
                      <span class="badge badge-pill bg-warning" data-bs-toggle="tooltip" data-placement="top" data-original-title="<?php e__('Status') ?>""><?php e__('Pending Approval') ?></span>
                    <?php else: ?>
                  ...
                  <div class="message">
                    <div class="message-content">
                      <div class="message-header">
                        <div class="message-username" style="font-weight: bold;">
                          <?php e__('Reason'); ?>:
                        </div>
                      </div>
