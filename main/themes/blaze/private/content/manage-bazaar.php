    ...
    <div class="row">
                  ...
                  <table class="table table-hover">
                    ...
                    <?php foreach ($items as $readItems): ?>
                      <tr>
                        ...
                        <td>
                          <?php if ($readItems["sold"] == 0): ?>
                            <?php if ($readItems["price"] == 0): ?>
                              <span class="badge badge-pill bg-warning"><?php e__('In Storage') ?></span>
                            <?php else: ?>
                              <span class="badge badge-pill bg-success"><?php e__('On Sale') ?></span>
                            <?php endif; ?>
                          <?php else: ?>
                            <span class="badge badge-pill bg-danger"><?php e__('Sold') ?></span>
                          <?php endif; ?>
                        </td>
                        <td>
                        ...
                        <td class="text-end">
                          <a class="btn btn-success btn-circle" href="/manage-bazaar/<?php echo $readItems["id"]; ?>" data-bs-toggle="tooltip" data-placement="top" title="<?php e__('Edit') ?>">
                            <i class="shi shi-edit-2"></i>
                          </a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
              ...
              <?php if ($bazaarHistory->rowCount() > 0): ?>
                <div class="card">
                  <div class="card-header">
                    <div class="row">
                      <div class="col">
                        <h2 class="card-title"><?php e__('Bazaar History') ?></h2>
                      </div>
                      <div class="col-auto">
      ...
      <?php elseif (get("action") == 'help'): ?>
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h2 class="card-title"><?php e__('Bazaar Help') ?></h2>
            </div>
            <div class="card-body">
