                ...
                <?php foreach ($products as $readProducts): ?>
                  <div class="col-md-3 col-sm-6 mb-grid-gutter">
                    <div class="card card-product card-hover">
                      <img class="card-img-top lazyload" data-src="/apps/main/public/assets/img/items/<?php echo strtolower($readProducts["itemID"]).'.png'; ?>" src="/apps/main/public/assets/img/loaders/store.png">
                      <div class="card-body">
