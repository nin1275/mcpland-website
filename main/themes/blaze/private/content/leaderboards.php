<?php
  ...
  $extraResourcesJS->addResource(themePath().'/public/assets/js/leaderboards.js');
        ...
        <?php if ($leaderboardServers->rowCount() > 0): ?>
          <div class="card">
            <div class="card-header">
              <h2 class="card-title leaderboards"><?php e__('Servers') ?></h2>
            </div>
            ...
            <div class="card">
              ...
              <div id="loader" class="card-body p-0 is-loading">
                ...
                <div id="searchBox" class="input-group">
                  ...
                  <input type="text" id="inputSearch" class="form-control border-0" placeholder="<?php e__('Search player...') ?>" aria-label="<?php e__('Search player...') ?>" aria-describedby="ariaSearch" style="height: calc(2.5rem + 2px);">
                  <div class="input-group-append">
                    <button type="button" id="cancelSearch" class="search-cancel" style="display: none;"><i class="fa fa-times"></i></button>
                    <button type="button" id="ariaSearch" class="btn btn-success border-0" style="border-radius: 0 !important;"><?php e__('Search') ?></button>
                  </div>
                </div>
