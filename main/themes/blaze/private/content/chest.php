            ...
            <?php if ($chests->rowCount() > 0): ?>
              <div class="card">
                <div class="card-header">
                  <h2 class="card-title"><?php e__('Chest') ?> (<?php echo $chestCount; ?>)</h2>
                </div>
                          ...
                          <tr id="chest-<?php echo $readChests["id"]; ?>">
                            ...
                            <td>
                              <div class="input-group" style="width: 130px;">
                                ...
                                <input type="text" id="amountChanger-<?php echo $readChests["id"]; ?>" class="form-control form-control-sm text-center px-0" value="<?php echo $readChests["amount"]; ?>" min="1" max="<?php echo $readChests["amount"]; ?>" autocomplete="off">
                            ...
                            <td class="text-end">
                              <button type="button" class="btn btn-success btn-circle deliverButton" data-chest="<?php echo $readChests["id"]; ?>" data-bs-toggle="tooltip" data-placement="top" title="<?php e__('Take Delivery') ?>">
                                <i class="fa fa-check"></i>
                              </button>
                              <?php if ($readSettings["giftStatus"] == 1): ?>
                                <a class="btn btn-primary btn-circle" href="/chest/gift/<?php echo $readChests["id"]; ?>" data-bs-toggle="tooltip" data-placement="top" title="<?php e__('Send as Gift') ?>">
            ...
            <?php if ($chestsHistory->rowCount() > 0): ?>
              <div class="card">
                <div class="card-header">
                  <div class="row">
                    <div class="col">
                      <h2 class="card-title"><?php e__('Chest History') ?></h2>
                    </div>
                    <div class="col-auto">
