              ...
              <?php if ($account->rowCount() > 0): ?>
                ...
                <div class="card">
                  <div class="card-header">
                    <h2 class="card-title"><?php e__('Two Factor Authentication') ?></h2>
                  </div>
                  <div class="card-body">
                    <form action="" method="post">
                      ...
                      <button type="submit" class="theme-color btn btn-primary w-100" name="verifyTFA"><?php e__('Verify') ?></button>
                    </form>
                  </div>
