<?php
  ...
  $extraResourcesJS->addResource(themePath().'/public/assets/js/plugins/superwheel/superwheel.min.js');
  $extraResourcesJS->addResource(themePath().'/public/assets/js/lottery.js');
?>
                ...
                <?php if ($lotteryHistory->rowCount() > 0): ?>
                  <div class="card mb-3">
                    <div class="card-header">
                      <div class="row">
                        <div class="col">
                          <h2 class="card-title"><?php e__('%title% History', ['%title%' => $readLottery["title"]]) ?></h2>
                        </div>
                        <div class="col-auto">
                        ...
                        <table class="table table-hover">
                          <thead>
                            <tr>
                              ...
                              <th class="text-end"><?php e__('Prize') ?></th>
                            </tr>
                          </thead>
                          <tbody>
