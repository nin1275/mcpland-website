      ...
      <?php if (get("action") == "getAll"): ?>
        <div class="row">
              ...
              <?php foreach ($rootCategories as $readRootCategories): ?>
                <div class="card">
                  <div class="card-header">
                    <a class="card-title h2" href="/forum/categories/<?php echo $readRootCategories["id"]."/".$readRootCategories["slug"]; ?>">
                  ...
                  <div class="card-body">
                    ...
                    <?php foreach ($childCategories as $readChildCategories): ?>
                      <div class="row border-bottom align-items-center mb-2 pb-3">
                        ...
                        <div class="col">
                          <a href="/forum/categories/<?php echo $readChildCategories["id"]."/".$readChildCategories["slug"]; ?>" class="fw-bold">
                          ...
                          <?php if ($subChildCategories->rowCount() > 0): ?>
                            <div>
                              <?php foreach ($subChildCategories as $readSubChildCategories): ?>
                                <a class="small me-2" href="/forum/categories/<?php echo $readSubChildCategories["id"]."/".$readSubChildCategories["slug"]; ?>">
          ...
          <div class="col-md-4">
            <div class="card">
              <div class="card-header">
                <h2 class="card-title"><?php e__('Latest Threads') ?></h2>
              </div>
                ...
                <?php if ($lastThreads->rowCount() > 0): ?>
                  <?php foreach ($lastThreads as $readLastThreads): ?>
                    <div class="row border-bottom align-items-center mb-2 pb-3">
                      ...
                      <div class="col">
                        <a href="/forum/threads/<?php echo $readLastThreads["id"]."/".$readLastThreads["slug"]; ?>" class="fw-bold">
            ...
            <div class="card">
              <div class="card-header">
                <h2 class="card-title"><?php e__('Latest Replies') ?></h2>
              </div>
              <div class="card-body pt-3 pb-0">
                <?php
                ...
                <?php if ($lastReplies->rowCount() > 0): ?>
                  <?php foreach ($lastReplies as $readLastReplies): ?>
                    <div class="row border-bottom align-items-center mb-2 pb-3">
                      ...
                      <div class="col">
                        <a href="/forum/threads/<?php echo $readLastReplies["id"]."/".$readLastReplies["slug"]; ?>" class="fw-bold">
              ...
              <div class="row align-items-center mb-3">
                ...
                <div class="col-auto">
                  <?php if (isset($_SESSION["login"])): ?>
                    <a href="/forum/threads/create?category=<?php echo $readCategory["id"]; ?>" class="btn btn-success">
                  ...
                  <div class="card-body">
                    <?php foreach ($threads as $readThreads): ?>
                      <div class="row border-bottom align-items-center mb-2 pb-3">
                        ...
                        <div class="col">
                          <a href="/forum/threads/<?php echo $readThreads["id"]."/".$readThreads["slug"]; ?>" class="fw-bold">
    ...
    <?php elseif (get("target") == "threads"): ?>
      <?php if (get("action") == "get" && get("id")): ?>
        <?php if ($thread->rowCount() > 0): ?>
          ...
          ?>
          <div class="mb-3 mt-2">
            <h1 class="h3 fw-bold"><?php echo $readThread["title"]; ?></h1>
                ...
                <div class="card mb-0">
                  <div class="card-body text-center">
                    <a href="/player/<?php echo $readThread["realname"]; ?>" class="d-block">
                      ...
                      <?php echo styledUsername($readThread["realname"], $userRoles[0]["slug"], false, "d-block mb-2 fw-bold"); ?>
                    </a>
                      ...
                      <div class="row">
                        ...
                        <div class="col-auto">
                          <?php if (isset($_SESSION["login"]) && ($readThread["accountID"] == $readAccount["id"] || checkPerm($readAccount, 'MANAGE_FORUM'))): ?>
                            <a href="/forum/threads/edit/<?php echo $readThread["id"]; ?>" class="me-2">
                              <i class="fa fa-edit"></i> <?php e__('Edit') ?>
                            </a>
                            <a href="/forum/threads/delete/<?php echo $readThread["id"]; ?>" class="text-danger clickdelete">
                              <i class="fa fa-trash"></i> <?php e__('Delete') ?>
                            </a>
                          <?php endif; ?>
                        </div>
                      </div>
                  ...
                  <div class="card mb-0">
                    <div class="card-body text-center">
                      <a href="/player/<?php echo $readReplies["realname"]; ?>" class="d-block">
                        ...
                        <?php echo styledUsername($readReplies["realname"], $userRoles[0]["slug"], false, "d-block mb-2 fw-bold"); ?>
                      </a>
                      <?php foreach ($userRoles as $role): ?>
                        <span class="role__default <?php echo "role__".$role["slug"] ?>">
                          <?php echo $role["name"]; ?>
                        ...
                        <div class="row">
                          ...
                          <div class="col-auto">
                            <?php if (isset($_SESSION["login"]) && ($readReplies["accountID"] == $readAccount["id"] || checkPerm($readAccount, 'MANAGE_FORUM'))): ?>
                              <a href="/forum/replies/edit/<?php echo $readReplies["id"]; ?>" class="me-2">
                                <i class="fa fa-edit"></i> <?php e__('Edit') ?>
                              </a>
                  ...
                  <div class="card-body text-center">
                    <div class="flex">
                      <a href="/profile" class="d-block">
                        ...
                        <span class="d-block mb-2 fw-bold"><?php echo $readAccount["realname"]; ?></span>
                      </a>
                    </div>
                  </div>
                </div>
