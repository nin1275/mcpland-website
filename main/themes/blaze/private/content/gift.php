            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="" method="post" class="needs-validation" novalidate="">
                  <label class="form-label px-0" for="inputGiftName"><?php e__('Code') ?>:</label>
                  <div class="input-group mb-3">
                    <i class="shi-gift position-absolute top-50 start-0 translate-middle-y ms-3"></i>
                    <input name="giftName" id="inputGiftName" class="form-control rounded" type="text" placeholder="<?php e__('Enter the gift code.') ?>" required="">
                  </div>
                      ...
                      <div class="col-8">
                        ...
                        <div class="mt-4">
                          <form action="" method="post">
                            ...
                            <button type="submit" class="btn btn-success w-100" name="getGift"><?php e__('Get the Gift') ?></button>
                          </form>
                        </div>
                      </div>
                    <?php else: ?>
            ...
            <?php if ($productGiftsHistory->rowCount() > 0): ?>
              <div class="card mb-3">
                <div class="card-header">
                  <div class="row">
                    <div class="col">
                      <h2 class="card-title"><?php e__('Gift History') ?></h2>
                    </div>
                    <div class="col-auto">
