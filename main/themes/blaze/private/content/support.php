<?php
  ...
  if (get("target") == 'support' && (get("action") == 'insert' || get("action") == 'get')) {
    ...
    $extraResourcesJS->addResource(themePath().'/public/assets/js/support.js');
    if (get("action") == 'insert') {
      $extraResourcesJS->addResource(themePath().'/public/assets/js/support.open.js');
    }
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <?php if (get("target") == 'support'): ?>
          <?php if (get("action") == 'getAll'): ?>
            ...
            ?>
            <a class="btn btn-success w-100 mb-3" href="/support/create"><?php e__('Open Ticket') ?></a>
                        ...
                        <?php foreach ($supports as $readSupports): ?>
                          <tr>
                            ...
                            <td class="text-center">
                              ...
                              <a class="btn btn-danger btn-circle clickdelete" href="/support/delete/<?php echo $readSupports["id"]; ?>" data-bs-toggle="tooltip" data-placement="top" title="<?php e__('Delete') ?>">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="" method="post">
                  ...
                  <label for="selectServer" class="form-label px-0"><?php e__('Server') ?>:</label>
                  <div class="mb-3">
                    <?php
                  ...
                  <div class="clearfix">
                    <div class="float-end">
                      <button type="submit" class="btn btn-success btn-rounded" name="insertSupports"><?php e__('Send') ?></button>
                    </div>
                  </div>
                </form>
              </div>
          ...
          <?php elseif (get("action") == 'get' && isset($_GET["id"])): ?>
            ...
            <?php if ($support->rowCount() > 0): ?>
              ...
              <div class="mb-3">
                <h1 class="h2 mb-2">
                  <?php echo substr($readSupport["title"], 0, 50); ?>
                </h1>
                <div class="mb-4">
                  <span class="badge badge-pill bg-primary" data-bs-toggle="tooltip" data-placement="top" data-original-title="<?php e__('Server') ?>">
                    <?php echo $readSupport["serverName"]; ?>
                  </span>
                  <span class="badge badge-pill bg-primary" data-bs-toggle="tooltip" data-placement="top" data-original-title="<?php e__('Category') ?>">
                    <?php echo $readSupport["categoryName"]; ?>
                  </span>
                  <span class="badge badge-pill bg-primary" data-bs-toggle="tooltip" data-placement="top" data-original-title="<?php e__('Date') ?>">
                    <?php echo convertTime($readSupport["creationDate"], 2, true); ?>
                  </span>
                  <?php if ($readSupport["statusID"] == 1): ?>
                    <span class="badge badge-pill bg-info" data-bs-toggle="tooltip" data-placement="top" data-original-title="<?php e__('Status') ?>"><?php e__('Open') ?></span>
                  <?php elseif ($readSupport["statusID"] == 2): ?>
                    <span class="badge badge-pill bg-success" data-bs-toggle="tooltip" data-placement="top" data-original-title="<?php e__('Status') ?>""><?php e__('Answered') ?></span>
                  <?php elseif ($readSupport["statusID"] == 3): ?>
                    <span class="badge badge-pill bg-warning" data-bs-toggle="tooltip" data-placement="top" data-original-title="<?php e__('Status') ?>""><?php e__('User-Reply') ?></span>
                  <?php elseif ($readSupport["statusID"] == 4): ?>
                    <span class="badge badge-pill bg-danger" data-bs-toggle="tooltip" data-placement="top" data-original-title="<?php e__('Status') ?>""><?php e__('Closed') ?></span>
                  <?php else: ?>
                    <span class="badge badge-pill bg-danger" data-bs-toggle="tooltip" data-placement="top" data-original-title="<?php e__('Status') ?>""><?php e__('Error!') ?></span>
                  <?php endif; ?>
                </div>
                      ...
                      <div class="row">
                        <div class="col-auto">
                          <a href="/player/<?php echo $readSupport["realname"]; ?>">
                            <?php echo minecraftHead($readSettings["avatarAPI"], $readSupport["realname"], 42, "float-left"); ?>
                          </a>
                        </div>
                        <div class="col ps-0">
                          ...
                          <div class="row">
                            <div class="col-auto">
                              <a href="/player/<?php echo $readSupportMessages["realname"]; ?>">
                                <?php echo minecraftHead($readSettings["avatarAPI"], $readSupportMessages["realname"], 42, "float-left"); ?>
                              </a>
                            </div>
                            <div class="col ps-0">
                              <div class="row align-items-center mb-2">
                ...
                <?php if ($readSupport["statusID"] != 4): ?>
                  <div class="card">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-auto">
                          <?php echo minecraftHead($readSettings["avatarAPI"], $readAccount["realname"], 42, "float-left"); ?>
                        </div>
                        <div class="col ps-0">
                          <form action="" method="POST" class="needs-validation" novalidate="">
                            ...
                            <div class="d-flex justify-content-end">
                              <button type="submit" class="btn btn-success mt-3" name="insertSupportMessages"><?php e__('Send') ?></button>
                            </div>
                          </form>
                        </div>
                      </div>
      ...
      <div class="col-md-4">
        ...
        <?php if ($onlineAccountsHistory->rowCount() > 0): ?>
          <div class="card">
            <div class="card-header">
              <h2 class="card-title online-staff">
              ...
              <ul class="list-group list-group-flush">
                <?php foreach ($onlineAccountsHistory as $readOnlineAccountsHistory): ?>
                  <li class="list-group-item">
                    <a href="/player/<?php echo $readOnlineAccountsHistory["realname"]; ?>" data-bs-toggle="tooltip" data-placement="left" data-original-title="<?php e__('Last Seen') ?>: <?php echo convertTime($readOnlineAccountsHistory["creationDate"]); ?>">
                      <div class="row">
                        <div class="col">
                          <?php echo minecraftHead($readSettings["avatarAPI"], $readOnlineAccountsHistory["realname"], 20, "me-2"); ?>
                          <span class="h6">
