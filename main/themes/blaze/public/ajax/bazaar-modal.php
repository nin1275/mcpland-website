        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <div class="modal-title d-flex align-items-center h2 card-title" id="buyModalLabel"><?php e__('Bazaar') ?> <i class="shi-chevron-right mx-1"></i> <?php echo $readProducts["name"]; ?></div>
            ...
            <div class="modal-body">
              <div class="row">
                ...
                <div class="col-8">
                  ...
                  <div class="row">
                    <span class="col-sm-4 fw-bold"><?php e__('ID') ?></span>
                    <span class="col-sm-8"><?php echo $readProducts["itemID"]; ?></span>
                  </div>
                  <div class="row">
                    <span class="col-sm-4 fw-bold"><?php e__('Amount') ?>:</span>
                    <span class="col-sm-8"><?php echo $readProducts["amount"]; ?></span>
                  </div>
                  <div class="row">
                    <span class="col-sm-4 fw-bold"><?php e__('Durability') ?>:</span>
                  ...
                  <div class="row">
                    <span class="col-sm-4 fw-bold"><?php e__('Seller') ?>:</span>
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><?php e__('Cancel') ?></button>
