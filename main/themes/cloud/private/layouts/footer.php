      ...
      <div class="row justify-content-center">
        <div class="col-md-12">
          <div class="w-100 text-center mb-5">
            <img class="mb-4" src="/apps/main/public/assets/img/extras/header-logo.png?cache=<?php echo $readTheme["updatedAt"] ?>" alt="" height="75px">
            <br>
          ...
          <?php if ($readSettings["footerFacebook"] != '0'): ?>
            <li class="mb-2">
              <a href="<?php echo $readSettings["footerFacebook"]; ?>" rel="external">
                <i class="bi bi-facebook text-white mr-1"></i> Facebook
              </a>
            </li>
          <?php endif; ?>
          <?php if ($readSettings["footerTwitter"] != '0'): ?>
            <li class="mb-2">
              <a href="<?php echo $readSettings["footerTwitter"]; ?>" rel="external">
                <i class="bi bi-twitter text-white mr-1"></i> Twitter
              </a>
            </li>
          <?php endif; ?>
          <?php if ($readSettings["footerInstagram"] != '0'): ?>
            <li class="mb-2">
              <a href="<?php echo $readSettings["footerInstagram"]; ?>" rel="external">
                <i class="bi bi-instagram text-white mr-1"></i> Instagram
              </a>
            </li>
          <?php endif; ?>
          <?php if ($readSettings["footerYoutube"] != '0'): ?>
            <li class="mb-2">
              <a href="<?php echo $readSettings["footerYoutube"]; ?>" rel="external">
                <i class="bi bi-youtube text-white mr-1"></i> Youtube
              </a>
            </li>
          <?php endif; ?>
          <?php if ($readSettings["footerDiscord"] != '0'): ?>
            <li class="mb-2">
              <a href="<?php echo $readSettings["footerDiscord"]; ?>" rel="external">
                <i class="bi bi-discord text-white mr-1"></i> Discord
              </a>
            </li>
          <?php endif; ?>
        <?php else: ?>
        ...
        <?php if ($readSettings["footerWhatsapp"] != '0'): ?>
          <li class="mb-2">
            <a href="https://wa.me/<?php echo str_replace(array("+", " "), array('', ''), $readSettings["footerWhatsapp"]); ?>" rel="external">
              <i class="bi bi-whatsapp text-white mr-1"></i> <?php echo $readSettings["footerWhatsapp"]; ?>
            </a>
          </li>
        <?php endif; ?>
      <?php else: ?>
...
<div class="w-100 text-center position-relative z-index-999">
  <a href="https://sofixa.com" target="blank"><img data-toggle="tooltip" data-placement="top" title="Theme: Sofixa" src="<?php echo themePath(); ?>/public/assets/img/sofixa-icon.png" class="sofixa-footer-icon info-icon-footer mr-1"></a>
  <a href="https://leaderos.net" target="blank">
    <img data-toggle="tooltip" data-placement="top" title="Powered by LeaderOS" src="<?php echo themePath(); ?>/public/assets/img/leaderos-icon.png" class="leaderos-footer-icon info-icon-footer"></a>
  </div>
  <div class="w-100 mt-3 text-center position-relative z-index-999">
