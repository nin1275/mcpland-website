...
<style>
  ...
  :root {
    ...
    --banner-logo-size: 240px;

    --body-color: 236,241,246; /* MainColor #ecf1f6 */

    --header-banner-background: 52,173,241; /* ThirdColor #34adf1 */

    --banner-background-text: 255,255,255; /* TextColor #ffffff */

    --navbar-bg-color: 255,255,255; /* InputBackgroundColor #ffffff */

    --navbar-text-color: 104,104,104; /* NewsTextColor #1d1d1d */

    --breadcrumb-text-color: 255,255,255; /* TextColor #ffffff */

    --secondary-color: 0,69,118; /* FooterTopColor #004576 */

    --secondary-text-color: 255,255,255; /* TextColor #ffffff */

    --card-text-color-1: 0,0,0; /* FooterBottomColor #000000 */

    --card-text-color-2: 114,114,114; /* ServerTextColor #727272 */

    --footer-bottom-background: 52,173,241; /* BodyColor #34adf1 */

    --footer-text-color-1: 243,243,243; /* buttonTextColor #f3f3f3 */

    --footer-text-color-2: 243,243,243; /* buttonTextColor #f3f3f3 */
