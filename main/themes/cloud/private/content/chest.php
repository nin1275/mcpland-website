                  ...
                  <form action="" method="post">
                    ...
                    <div class="clearfix">
                      <div class="float-right">
                        <button type="submit" class="btn btn-banner-bg" name="sendGift" onclick="return confirm('<?php e__('Are you sure you want to send the gift to this player?') ?>')"><?php e__('Send') ?></button>
                      </div>
                    </div>
                  </form>
                </div>
