                        ...
                        <div class="card-body">
                          <div class="store-card">
                            ...
                            <div class="store-card-button">
                              ...
                              <?php endif; ?>
                              <?php if ($readProducts["stock"] == 0): ?>
                                <button class="btn btn-danger w-100 stretched-link disabled">
                                  <?php e__('Out of Stock!') ?>
                                </button>
                              <?php else: ?>
                                <button class="btn btn-banner-bg w-100 stretched-link openBuyModal" product-id="<?php echo $readProducts["id"]; ?>">
