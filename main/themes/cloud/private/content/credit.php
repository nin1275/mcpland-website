                      ...
                      <div class="row justify-content-center">
                        <div class="col-md-6">
                          <div class="card text-center">
                            <div class="card-body">
                              <div class="w-100">
                                <img class="w-50 mb-2" src="<?php echo themePath(); ?>/public/assets/img/coins.webp" alt="">
                        ...
                        <div class="col-md-6">
                          <div class="card text-center">
                            <div class="card-body">
                              <div class="w-100">
                                <img class="w-50 mb-2" src="<?php echo themePath(); ?>/public/assets/img/wallet.webp" alt="">
                                <div class="sfx-input-icon">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form action="" method="post">
                    ...
                    <div class="clearfix">
                      <div class="float-right">
                        <button type="submit" class="btn btn-banner-bg" name="sendCredit" onclick="return confirm('<?php e__('Are you sure you want to send the credit to this player?') ?>')"><?php e__('Send Credit') ?></button>
                      </div>
                    </div>
                  </form>
                </div>
              ...
              <?php if (get("result") == 'success'): ?>
                <div class="card mb-3">
                  ...
                  <div class="card-body text-success text-center">
                    ...
                    <a href="/store" class="btn btn-banner-bg mb-3"><?php e__('Start Shopping!') ?></a>
                  </div>
                </div>
              <?php elseif (get("result") == 'unsuccess'): ?>
                <div class="card mb-3">
                  ...
                  <div class="card-body text-danger text-center">
                    ...
                    <a href="/credit/buy" class="btn btn-banner-bg mb-3"><?php e__('Try Again!') ?></a>
                  </div>
                </div>
              <?php else: ?>
                <?php go("/404"); ?>
