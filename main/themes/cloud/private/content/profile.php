              ...
              <div class="card-body p-0">
                <nav>
                  <div class="nav nav-tabs nav-fill" id="nav-profile-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link" id="nav-store-bazaar-tab" data-toggle="tab" href="#nav-bazaar-history" role="tab" aria-controls="nav-bazaar-history" aria-selected="false"><?php e__('Bazaar History') ?></a>
                  </div>
                </nav>
                <div class="tab-content" id="nav-tabContent">
                ...
                <form action="" method="post">
                  ...
                  <div class="clearfix">
                    <div class="float-right">
                      <button type="submit" class="btn btn-banner-bg" name="updateAccounts"><?php e__('Save Changes') ?></button>
                    </div>
                  </div>
                </form>
              </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="" method="post">
                  ...
                  <div class="clearfix">
                    <div class="float-right">
                      <button type="submit" class="btn btn-banner-bg" name="changePassword"><?php e__('Change Password') ?></button>
                    </div>
                  </div>
                </form>
              </div>
