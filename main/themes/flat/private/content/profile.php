        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row justify-content-between">
              <div class="col-md-12">
                <a class="btn btn-success w-100" href="/profile/edit"><?php e__('Edit Profile') ?></a>
              </div>
              <div class="col-md-12 mt-2">
                <a class="btn btn-primary w-100" href="/profile/change-password"><?php e__('Change Password') ?></a>
              </div>
            </div>
          </div>
        </div>
