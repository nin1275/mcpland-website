            ...
            <div class="col-lg-4 col-sm-6 mb-grid-gutter">
              <a class="card h-100 shadow-none border" href="/help/topics/<?php echo $readHelpTopics["slug"]; ?>">
                <div class="card-body ps-grid-gutter pe-grid-gutter text-center">
                  ...
                  <div class="btn btn-primary mb-2"><?php e__('View') ?></div>
                </div>
              </a>
            </div>
          <?php endforeach ?>
      ...
      <div class="row">
        ...
        <div class="col-md-3 mb-3">
          <div class="mb-4">
            <form action="/help" method="GET">
              <div class="input-group">
                <input name="search" class="form-control rounded" type="text" placeholder="<?php e__('Search...') ?>" style="height: 48px;">
              </div>
            </form>
          </div>
          <!-- Related articles-->
...
<section class="bg-white py-5">
  <div class="container text-center">
    ...
    <a class="btn btn-rounded btn-success" href="/support/create"><?php e__('Open Ticket') ?></a>
  </div>
</section>