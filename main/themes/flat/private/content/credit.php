                ...
                <div class="card-body">
                  <form id="buyCreditsForm" action="/apps/main/public/ajax/pay.php" method="post">
                    <div class="form-group row">
                      <label for="inputUsername" class="col-sm-3 col-form-label"><?php e__('Username') ?>:</label>
                      <div class="col-sm-9">
                        <input type="text" id="inputUsername" class="form-control" value="<?php echo $readAccount["realname"]; ?>" readonly="readonly">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputPrice" class="col-sm-3 col-form-label"><?php e__('Amount') ?>:</label>
                      <div class="col-sm-9">
                        <div class="input-group">
                          <input type="number" id="inputPrice" class="form-control" name="price" placeholder="<?php e__('Enter the amount.') ?>" min="<?php echo $readSettings["minPay"]; ?>" max="<?php echo $readSettings["maxPay"]; ?>" required="required">
                    ...
                    <div class="form-group row">
                      <label for="selectPayment" class="col-sm-3 col-form-label"><?php e__('Payment Method') ?>:</label>
                      <div class="col-sm-9">
                    ...
                    <?php if ($payment->rowCount() > 0): ?>
                      ...
                      ?>
                      <div class="form-group row">
                        <label for="inputFirstName" class="col-sm-3 col-form-label"><?php e__('First Name') ?>:</label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group row">
                        <label for="inputLastName" class="col-sm-3 col-form-label"><?php e__('Last Name') ?>:</label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group row">
                        <label for="inputEmail" class="col-sm-3 col-form-label"><?php e__('Email') ?>:</label>
                        <div class="col-sm-9">
