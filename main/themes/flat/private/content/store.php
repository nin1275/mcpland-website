                  ...
                  <ul class="list-group list-group-flush">
                    <?php foreach ($servers as $readServers): ?>
                      <li class="list-group-item <?php echo ($readServers["slug"] == get("server")) ? "active":null; ?>">
                        <a href="/store/<?php echo $readServers["slug"]; ?>">
                          <?php echo $readServers["name"]; ?>
                        </a>
                      </li>
                    <?php endforeach; ?>
                              ...
                              <div class="store-card-button">
                                <?php if ($readTopSales["stock"] != -1): ?>
                                  <div class="mb-2">
                                    ...
                                    <?php else : ?>
                                      <?php e__('%stock% in stock', ['%stock%' => $readTopSales["stock"]]) ?>
                                    <?php endif; ?>
                                  </div>
                                <?php endif; ?>
                                <?php if ($readTopSales["stock"] == 0): ?>
                                ...
                                <?php else: ?>
                                  <button class="btn btn-success w-100 stretched-link openBuyModal" product-id="<?php echo $readTopSales["id"]; ?>"><?php e__('Buy Now') ?></button>
                                <?php endif; ?>
                              </div>
                            </div>
                          </div>
                      ...
                      <?php foreach ($productCategories as $readProductCategories): ?>
                        <div class="col-md-3">
                          <div class="store-card">
                            ...
                            <a class="btn btn-primary w-100 stretched-link store-card-button" href="/store/<?php echo $readThisServer["slug"]; ?>/<?php echo $readProductCategories["slug"]; ?>"><?php e__('View') ?></a>
                          </div>
                        </div>
                      <?php endforeach; ?>
                    </div>
                              ...
                              <?php if ($readProducts["stock"] != -1): ?>
                                <div class="mb-2">
                                  <?php if ($readProducts["stock"] == 0): ?>
                                    <span class="text-danger small"><?php e__('Out of Stock!') ?></span>
                                  <?php else : ?>
                                    <?php e__('%stock% in stock', ['%stock%' => $readProducts["stock"]]) ?>
                                  <?php endif; ?>
                                </div>
                              <?php endif; ?>
                              <?php if ($readProducts["stock"] == 0): ?>
                                <button class="btn btn-danger w-100 stretched-link disabled"><?php e__('Out of Stock!') ?></button>
                              <?php else: ?>
                                <button class="btn btn-success w-100 stretched-link openBuyModal" product-id="<?php echo $readProducts["id"]; ?>"><?php e__('Buy Now') ?></button>
                              <?php endif; ?>
                            </div>
                          </div>
                        </div>
